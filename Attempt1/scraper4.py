...
def main():
    ...
    # 1) Load the view HTML (this is where the bootstrapSession URL is embedded)
    r0 = s.get(VIEW_URL, timeout=30)
    print("view HTML HTTP:", r0.status_code)
    r0.raise_for_status()

    bootstrap_url = find_bootstrap_url(r0.text)
    scrape_with_bootstrap_url(bootstrap_url)
